...
public class MatchScoreCalculationServiceTest {
    ...
    public void testFirstWonPointByPlayer_FifteenVSLove() {
        PlayerScore firstPlayerScore = new PlayerScore("John");
        PlayerScore secondPlayerScore = new PlayerScore("Bob");
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//15-0
    ...
    public void testSecondWonPointByPlayer_ThirtyVSLove() {
        ...
        PlayerScore secondPlayerScore = new PlayerScore("Bob");
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//15-0
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//30-0
    ...
    public void testThirdWonPointByPlayer_FortyVSLove() {
        ...
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//15-0
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//30-0
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//40-0
    ...
    public void testSettingAdvantageWhenScore_FortyVSForty() {
        ...
        matchScoreCalculationService.handleWonPoint(secondPlayerScore, firstPlayerScore);//40-15
        matchScoreCalculationService.handleWonPoint(secondPlayerScore, firstPlayerScore);//40-30
        matchScoreCalculationService.handleWonPoint(secondPlayerScore, firstPlayerScore);//40-40

        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//AD-40
    ...
    public void testLosingAdvantageWhenScore_FortyVSAdvantage() {
        ...
        matchScoreCalculationService.handleWonPoint(secondPlayerScore, firstPlayerScore);//40-30
        matchScoreCalculationService.handleWonPoint(secondPlayerScore, firstPlayerScore);//40-40
        matchScoreCalculationService.handleWonPoint(secondPlayerScore, firstPlayerScore);//40-AD

        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//40-40
        assertEquals(Point.FORTY, firstPlayerScore.getPoint());
        assertEquals(Point.FORTY, secondPlayerScore.getPoint());
    }
    ...
    public void testGameOverWhenAdvantageVSForty() {
        ...
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//AD-40
        matchScoreCalculationService.handleWonPoint(firstPlayerScore, secondPlayerScore);//+1 game for Player1
    ...
    public void testTieBreakStartWhen6GamesVS6Games() {
        ...
        for (int i = 0; i < 20; i++) {
            matchScoreCalculationService.handleWonPoint(secondPlayerScore, firstPlayerScore);
        }
